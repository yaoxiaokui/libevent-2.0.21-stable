...
ACLOCAL = ${SHELL} /root/libevent-2.0.21-stable/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /root/libevent-2.0.21-stable/missing --run autoconf
AUTOHEADER = ${SHELL} /root/libevent-2.0.21-stable/missing --run autoheader
AUTOMAKE = ${SHELL} /root/libevent-2.0.21-stable/missing --run automake-1.11
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/libevent-2.0.21-stable/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
ZLIB_LIBS = -lz 
abs_builddir = /root/libevent-2.0.21-stable
abs_srcdir = /root/libevent-2.0.21-stable
abs_top_builddir = /root/libevent-2.0.21-stable
abs_top_srcdir = /root/libevent-2.0.21-stable
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = ${SHELL} /root/libevent-2.0.21-stable/install-sh
